...
function Players() {
  ...
  const flame = CardInfo("Flame", "Flame, one of our recent additions, hails from Latvia. He leverages his cunning tactics to stealthily gain an advantageous position on the battlefield. His exceptional skills enable him to single-handedly secure and defend a site with precision.", "../kj.gif", "player", "24, Latvia");
